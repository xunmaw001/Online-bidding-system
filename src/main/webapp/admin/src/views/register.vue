  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='zhaobiaozhe'" class="input-group">
			   <div class="label">招标账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhaobiaozhanghao" class="input" type="text" placeholder="招标账号">
			   </div>
			 </div> -->
			<el-form-item label="招标账号" class="input" v-if="tableName=='zhaobiaozhe'">
			  <el-input v-model="ruleForm.zhaobiaozhanghao" autocomplete="off" placeholder="招标账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhaobiaozhe'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhaobiaozhe'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='zhaobiaozhe'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='zhaobiaozhe'" class="input-group">
			   <div class="label">招标姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhaobiaoxingming" class="input" type="text" placeholder="招标姓名">
			   </div>
			 </div> -->
			<el-form-item label="招标姓名" class="input" v-if="tableName=='zhaobiaozhe'">
			  <el-input v-model="ruleForm.zhaobiaoxingming" autocomplete="off" placeholder="招标姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhaobiaozhe'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='zhaobiaozhe'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhaobiaozhe'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='zhaobiaozhe'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.zhaobiaozhanghao) && `zhaobiaozhe` == this.tableName){
        this.$message.error(`招标账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `zhaobiaozhe` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `zhaobiaozhe` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.zhaobiaoxingming) && `zhaobiaozhe` == this.tableName){
        this.$message.error(`招标姓名不能为空`);
        return
      }
      if(`zhaobiaozhe` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
      if(`zhaobiaozhe` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
