<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="投标编号" prop="toubiaobianhao">
            <el-input v-model="ruleForm.toubiaobianhao" 
                placeholder="投标编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toubiaobianhao" label="投标编号" prop="toubiaobianhao">
              <el-input v-model="ruleForm.toubiaobianhao" 
                placeholder="投标编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.toubiaowenjian" label="投标文件" prop="toubiaowenjian">
          <file-upload
          tip="点击上传投标文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.toubiaowenjian" label="投标文件" prop="toubiaowenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.toubiaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招标金额" prop="zhaobiaojine">
          <el-input v-model="ruleForm.zhaobiaojine" 
              placeholder="招标金额" clearable  :readonly="ro.zhaobiaojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招标金额" prop="zhaobiaojine">
              <el-input v-model="ruleForm.zhaobiaojine" 
                placeholder="招标金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投标金额" prop="toubiaojine">
          <el-input v-model="ruleForm.toubiaojine" 
              placeholder="投标金额" clearable  :readonly="ro.toubiaojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投标金额" prop="toubiaojine">
              <el-input v-model="ruleForm.toubiaojine" 
                placeholder="投标金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投标日期" prop="toubiaoriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toubiaoriqi" label="投标日期" prop="toubiaoriqi">
              <el-input v-model="ruleForm.toubiaoriqi" 
                placeholder="投标日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招标账号" prop="zhaobiaozhanghao">
          <el-input v-model="ruleForm.zhaobiaozhanghao" 
              placeholder="招标账号" clearable  :readonly="ro.zhaobiaozhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招标账号" prop="zhaobiaozhanghao">
              <el-input v-model="ruleForm.zhaobiaozhanghao" 
                placeholder="招标账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招标姓名" prop="zhaobiaoxingming">
          <el-input v-model="ruleForm.zhaobiaoxingming" 
              placeholder="招标姓名" clearable  :readonly="ro.zhaobiaoxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招标姓名" prop="zhaobiaoxingming">
              <el-input v-model="ruleForm.zhaobiaoxingming" 
                placeholder="招标姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="投标内容" prop="toubiaoneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.toubiaoneirong" label="投标内容" prop="toubiaoneirong">
                    <span v-html="ruleForm.toubiaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xingming : false,
	shouji : false,
	zhaobiaozhanghao : false,
	zhaobiaoxingming : false,
	lianxidianhua : false,
	sfsh : false,
	shhf : false,
	ispay : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='toubiaobianhao'){
            this.ruleForm.toubiaobianhao = obj[o];
	    this.ro.toubiaobianhao = true;
            continue;
          }
	    ...
	    this.ro.toubiaowenjian = true;
          ...
          if(o=='zhaobiaojine'){
            this.ruleForm.zhaobiaojine = obj[o];
	    this.ro.zhaobiaojine = true;
            continue;
          }
          if(o=='toubiaojine'){
            this.ruleForm.toubiaojine = obj[o];
	    this.ro.toubiaojine = true;
            continue;
          }
          if(o=='toubiaoneirong'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='zhaobiaozhanghao'){
            this.ruleForm.zhaobiaozhanghao = obj[o];
	    this.ro.zhaobiaozhanghao = true;
            continue;
          }
          if(o=='zhaobiaoxingming'){
            this.ruleForm.zhaobiaoxingming = obj[o];
	    this.ro.zhaobiaoxingming = true;
            continue;
          }
          if(o=='lianxidianhua'){
	...
	this.ruleForm.toubiaoneirong = this.ruleForm.toubiaoneirong.replace(reg,'../../../ssm1dl59/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.toubiaowenjian!=null) {
      ...
      if(parseInt(this.ruleForm.toubiaojine)>parseInt(this.ruleForm.zhaobiaojine)){
        this.$message.error("投标金额不能超过招标金额");
        return
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiangmutoubiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiangmutoubiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
