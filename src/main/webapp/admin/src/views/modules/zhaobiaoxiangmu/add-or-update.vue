  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="项目分类" prop="xiangmufenlei">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhaobiaozhanghao!=''&&json.zhaobiaozhanghao){
                this.ruleForm.zhaobiaozhanghao = json.zhaobiaozhanghao
	    		this.ro.zhaobiaozhanghao = true;
		}
		if(json.zhaobiaoxingming!=''&&json.zhaobiaoxingming){
                this.ruleForm.zhaobiaoxingming = json.zhaobiaoxingming
	    		this.ro.zhaobiaoxingming = true;
		}
	...
	this.ruleForm.xiangmuxiangqing = this.ruleForm.xiangmuxiangqing.replace(reg,'../../../ssm1dl59/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
