<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="专家编号" prop="zhuanjiabianhao">
            <el-input v-model="ruleForm.zhuanjiabianhao" 
                placeholder="专家编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuanjiabianhao" label="专家编号" prop="zhuanjiabianhao">
              <el-input v-model="ruleForm.zhuanjiabianhao" 
                placeholder="专家编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专家姓名" prop="zhuanjiaxingming">
          <el-input v-model="ruleForm.zhuanjiaxingming" 
              placeholder="专家姓名" clearable  :readonly="ro.zhuanjiaxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专家姓名" prop="zhuanjiaxingming">
              <el-input v-model="ruleForm.zhuanjiaxingming" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhuanjiabianhao'){
            this.ruleForm.zhuanjiabianhao = obj[o];
	    this.ro.zhuanjiabianhao = true;
            continue;
          }
	...
	this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../ssm1dl59/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
